        ...
        {mockedQuiz.map((q) => (
          <div className="border border-black bg-slate-200 h-3/4 w-3/4 flex justify-evenly flex-col items-center round shadow-lg">
            ...
            <div className="flex flex-col w-full items-center">
              <button className="m-2 p-4 w-10/12 min-h-7 shadow-md rounded-lg bg-gray-400 text-black border border-black hover:bg-gray-500 transition duration-200">
                {q.answer1}
              </button>
              <button className="m-2 p-4 w-10/12 min-h-7 shadow-md rounded-lg bg-gray-400 text-black border border-black hover:bg-gray-500 transition duration-200">
                {q.answer2}
            ...
            <button className="m-2 p-4 w-4/12 border text-black rounded-lg border-black shadow-md bg-gray-400 hover:bg-gray-500 transition duration-200">
              Next
            </button>
          </div>
        ))}
